...
/** Constructor definition
  *
  * The definition of a class (or other type) constructor. Very close to a [[FunctionDef]], except there is no return type and no name.
  */
...
/** Initializer statement
  ...
  * We type this as a definition since it is clearly a statement otherwise.
...
/** Function type
  ...
  * a notion of function types in our pseudo type trees.
  *
  * For example,
  *  - `(A,B) => C` in Scala
  */
...
/** Wildcard type
  *
  * Quite a few languages provide some sort of unknown type with bounds on it.
  *
  * For example:
...
/** Assignment expression
  *
  * Many languages accept inline assignment and dependent assignments.
  *
  * For example:
  *  - `a += 1`
  *  - `a = b = 1`
...
/** Guarded expression
  ...
  * encode these "guards" in guarded expressions.
  *
